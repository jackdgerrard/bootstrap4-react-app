...
This project was bootstrapped with [Bootstrap 4](https://getbootstrap.com) & [Create React App](https://github.com/facebookincubator/create-react-app).

[React bootstrap](https://react-bootstrap.github.io/) is still under development so in the mean time, 

I followed [these instructions](https://github.com/facebookincubator/create-react-app/blob/master/packages/react-scripts/template/README.md#adding-a-css-preprocessor-sass-less-etc) from create-react-app to run node-sass-chokidar, edited the package.json accordingly and put bootstrap 4's sass files into src folder. Just run your project as you normally would for create-react-app. I also added yarn and prettier as dev dependancies, just cause. 
